...
if solvetype==2
    ...
    for i=1:lt-1
        ...
        IStot=[IStot;sum(ISclass(2:end,1:63),2)/sum(NNfeed(1:63))];
        HHtot=[HHtot;sum(Hclass(2:end,1:63),2)/sum(NNfeed(1:63))];
        DDtot=[DDtot;sum(Dclass(2:end,1:63),2)/sum(NNfeed(1:63))];
