...
% tvec=[-61.3373   87.6062  245 275  306  336  367  398  426];
...
fun1=@(Xit)econGDP(objFun,pr,vx,n,ntot,na,NN,NNbar,NNrep,Din,beta,Xit,tvec,hospThresh,data);
...
function f=econGDP(obj,pr,vx,n,ntot,na,NN,NNbar,NNrep,Din,beta,Xit,tvec,hospThresh,data)

    Wit=Xit.^(1/pr.a);
    [~,~,~,deaths]=heRunCovid19(pr,vx,n,ntot,na,NN,NNbar,NNrep,Din,beta,Wit,tvec,0,data);
    
    YLL=deaths*[79.55;69.61;40.42;12.35];
    
    VSL=50*49050/10^6;
    
    VSLY=VSL/42.32;
    
    f=-sum(obj.*Xit)+YLL*VSLY;
